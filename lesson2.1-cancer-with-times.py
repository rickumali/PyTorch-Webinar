...
rfc_start_time = time.perf_counter()
# TIME
...
rfc_end_time = time.perf_counter()
total_rfc_time = rfc_end_time - rfc_start_time
print("Best polynomial features", X_poly_top.shape)
print(f"RandomForestClassifier time: {total_rfc_time:.4f} seconds")
